...
DEVELOPER_PROFILE=trime.usa@gmail.com
...
${APP_NAME}.ipa: ${APP_NAME}.app ${APP_NAME}.app/main ${APP_NAME}.app/Info.plist
	codesign --force --sign "${DEVELOPER_PROFILE}" --entitlements ent.plist ${APP_NAME}.app
